...
AddOutputFilter chunkFilter
		...
		<Item Name="Four US Control.vi" Type="VI" URL="../Four US Control.vi"/>
		<Item Name="Image Analysis.vi" Type="VI" URL="../Image Analysis.vi"/>
		<Item Name="Light Level Read.vi" Type="VI" URL="../Light Level Read.vi"/>
		<Item Name="Main.vi" Type="VI" URL="../Main.vi"/>
		<Item Name="Motor Control.vi" Type="VI" URL="../Motor Control.vi"/>
		<Item Name="Pitch Roll Control.vi" Type="VI" URL="../Pitch Roll Control.vi"/>
		<Item Name="Sensor Case Selector.vi" Type="VI" URL="../Sensor Case Selector.vi"/>
		<Item Name="Vision Aquisition (Sunlight).vi" Type="VI" URL="../Vision Aquisition (Sunlight).vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="PID Control Express (No Loop).vi" Type="VI" URL="../PID Control Express (No Loop).vi"/>
			<Item Name="Servo Control No Loop.vi" Type="VI" URL="../Servo Control No Loop.vi"/>
		</Item>
		<Item Name="Build Specifications" Type="Build"/>
	</Item>
</Project>
